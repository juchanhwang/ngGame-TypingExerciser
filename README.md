...
>
> 개념을 이해하고 적용하는 편을 좋아하기 때문에 모르는 것을 모르는 채로 두는 것은 괴로운 과정이었다. 하지만 이 과정에서 알게 된 사실이 있다. 이해 후에 적용하는 것보다 적용 후에 이해하는 것이 내가 습득하고 성장하는 속도가 빨랐다는 것이다. 그리고, 이 과정이 눈에 보이기 때문에 오히려 더 재미있게 코딩 할 수 있는 시간이었다. 한 달 동안 리액트를 공부한 시간보다 2주 동안 앵귤러를 공부한 시간이 나에게는 더 큰 성장을 가져다 주었고, 앞으로 어떻게 공부해야하는지 알게 된 과정이었다. 이 번 코딩 테스트 개발 과정에서 자신감이라는 것을 얻게 된 것 같다.
